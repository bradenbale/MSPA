...
% Refractive indices:
n1 = linspace(3.305, 3.44, 10);         % Lower cladding
...
for i = 1 : nmodes
    ...
    [x,y,xc,yc,nx,ny,eps,edges] = waveguidemesh([n1(i),n2(i),n3],[h1,h2,h3], ...
                                            rh,rw,side,dx,dy); 

    % First consider the fundamental TE mode:

    [Hx,Hy,neff] = wgmodes(lambda,n2(i),i,dx,dy,eps,'000A');
    ...
    [Hx,Hy,neff] = wgmodes(lambda,n2(i),i,dx,dy,eps,'000S');
